class ClangNls < Formula
  ...
  patch :p2 do
    url "https://github.com/paperchalice/llvm-clang/commit/10812291a0e336f02dd2ef2dca66acb67d345df1.patch?full_index=1"
  end
