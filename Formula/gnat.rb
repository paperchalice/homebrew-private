class Gnat < Formula
  ...
  def install
    ...
    ENV.prepend "PATH", "#{bootstrap_gcc_prefix}/bin:"
    ...
    mkdir "build" do
      ...
      system "make", "-C", "#{triple}/libada", "install"
      system "make", "-C", "gcc", "ada.install"

      gcc = Formula["paperchalice/private/gcc"]
      %w[gnat gnarl].each do |l|
        MachO::Tools.change_install_name lib/"gcc"/triple/version_suffix/"adalib"/shared_library("lib#{l}"),
