class GccAT12 < Formula
  ...
  def install
    if Hardware::CPU.intel?
      resource("bootstrap-gnat").stage buildpath/"bootstrap-gnat"
      ENV.prepend_path "PATH", buildpath/"bootstrap-gnat/bin"
    end
    ...
    languages << "ada" if Hardware::CPU.intel?
