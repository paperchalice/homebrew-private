class Qt < Formula
  ...
  # FIXME: https://bugreports.qt.io/browse/QTBUG-91644
  patch do
    url "https://bugreports.qt.io/secure/attachment/106418/macdeployqt_qt.patch"
    sha256 "a59aaa83b84a5f3d4f89adc434da36369ba30f3c7b806f7d5a9545f84642591e"
  end
  ...
  def install
    ...
    # TODO: qmake will be moved to share/qt/libexec
